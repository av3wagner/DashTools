...
GRlist = ['Всего', 'Мужчины', 'Женщины']
DocuList= ['О системе', 'История создания системы', 'Инструкция по эксплуатации', 'Об авторе']
land = tod_age 
...
def snapshot_page(value):
    if value == 'О системе':
        print("System: ", value)
        PDFfile="assets/SystemNNRZ.pdf"
    elif value == 'Об авторе':
        print("Autor: ", value)
        PDFfile="assets/AWagner-CV2023ru.pdf"  
    elif value == 'История создания системы':
        print("История: ", value)
        PDFfile="assets/GeschichteNNRZ.pdf"   
    elif value == 'Инструкция по эксплуатации':
        print("Инструкция: ", value)
        PDFfile="assets/Einleitung.pdf" 
        
    return html.ObjectEl(id="PdfSchow",
       data = PDFfile, 

...
def render_content(value): 
    ...
    if tab == 'Table0':
       ...
       html.Div(
        ...
        return html.Div(
                 className="six columns",
                 children=[html.Div(children=html.Iframe(id='PDFdocu', src="assets/GesamtNNRZ.html",
                 style={"height": "1090px", "width": "99.45%", 'margin-left': '5px', 'margin-right': '5px',
                        'vertical-align': 'top','textAlign': 'center', "scrolling": "True"}))],
